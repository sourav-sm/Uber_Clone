...
export default function CaptainSignup() {
    ...
    // const [Captain,setCaptain]=React.useContext(CaptainDataContext);//WRONG WAY
    ...
    const submitHandler= async (e)=>{ 
        ...
        const captainData={
          ...
          console.log('DAta sent to backend',captainData);


        try{
          const response=await axios.post(`${import.meta.env.VITE_BASE_URL}/captains/register`,captainData);
          if(response.status===201){//201 means the data is created successfully
